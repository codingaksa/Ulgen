            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-12">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        {error && (
                            <div className="bg-gray-700 border border-gray-600 text-gray-200 p-4 rounded-lg text-center space-y-3">
                                <div>{error}</div>
                                {error.includes('doğrulamanız') && (
                                    <button type="button" onClick={handleResend} className="px-3 py-2 rounded bg-blue-600 hover:bg-blue-700">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                type="button"
                                className="w-full flex justify-center items-center py-3 px-4 border border-gray-600 rounded-lg text-sm font-medium text-gray-300 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200"
                            >
                        ...
                        <div className="mt-6 text-center space-y-2">
                            <p>
                                <Link to="/forgot-password" className="text-blue-400 hover:text-blue-300">Şifremi unuttum</Link>
                            </p>
