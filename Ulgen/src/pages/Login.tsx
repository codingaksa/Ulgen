        ...
        <div className="max-w-md mx-auto w-full">
          <div className="bg-black rounded-2xl p-8 border border-gray-800 shadow-2xl">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              {error && (
                <div className="bg-[#121212] border border-gray-600 text-gray-200 p-4 rounded-lg text-center space-y-3">
                  <div>{error}</div>
                  {error.includes("doğrulamanız") && (
                    <button
                      type="button"
              ...
              <div className="space-y-3">
                <button
                  type="submit"
                  disabled={loading}
                  className="group relative w-full flex justify-center py-3 px-4 text-sm font-medium rounded-lg text-white bg-scroll-accent hover:bg-scroll-accent-strong focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8b5cf6] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
                  {loading ? (
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#1F1B24] text-gray-400">
                      veya
                    </span>
                  </div>
                </div>
                ...
                <button
                  type="button"
                  className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-scroll-accent hover:bg-scroll-accent-strong focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8b5cf6] transition-all duration-200"
                >
